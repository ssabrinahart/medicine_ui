...
function Profile () {
  ...
  const validatePassword = password => {
    ...
    return (
      hasLowercase && hasUppercase && hasNumber && hasSpecial && isLongEnough
    )
  }
        ...
        <section className='profile-section'>
          ...
          {medicalData && (
            <button
              className='button'
              onClick={() =>
                navigate('/history', { state: { editMode: true } })
              }
            >
        ...
        <section className='profile-section'>
          ...
          {showContactForm && (
            <div className='contact-form'>
              ...
              <button onClick={handleContactUpdate} className='mButtom'>
                Submit
              </button>
            </div>
          )}{' '}
